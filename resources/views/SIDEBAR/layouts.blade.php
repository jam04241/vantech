...
<body class="min-h-screen bg-gray-50">
    ...
    <div id="sidebar" class="sidebar border-r border-gray-200">
        ...
        <nav class="space-y-4 px-2">
            ...
            <!-- Reports Dropdown - Available to all authenticated users -->
            <details class="group">
                <summary class="dropdown-toggle">
                    <div class="flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            class="icon bi bi-file-earmark-bar-graph" viewBox="0 0 16 16">
                            <path
                ...
                <div class="dropdown-content space-y-1">
                    <a href="{{ route('sales.reports') }}" class="dropdown-item">Sales Reports</a>
                    <a href="{{ route('inventory.reports')}}" class="dropdown-item">Inventory
                        Reports</a>
                </div>
            </details>
